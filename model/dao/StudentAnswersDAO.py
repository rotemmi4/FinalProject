...
def get_answer_by_test_name_SUM(testName, visualization, set_num):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender, visualiztions.type, is_correct, SUM(time_to_answer)
     FROM StudentAnswers
...
def get_answer_by_test_name_reading_time(testName, visualization, set_num):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender,visualiztions.type, ReadingTime, SummaryTime
     FROM StudentInfo
