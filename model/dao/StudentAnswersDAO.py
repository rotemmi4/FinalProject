...
def get_answer_by_test_name_SUM(testName, visualization, set_num):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender, studentDivision, visualiztions.type, set_num, is_correct, SUM(time_to_answer)
     FROM StudentAnswers
...
def get_answer_by_test_name_COUNT(testName, visualization, set_num):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender, studentDivision, visualiztions.type, set_num, SUM(is_correct)
     FROM StudentAnswers
     INNER JOIN StudentInfo on StudentAnswers.studentID = StudentInfo.studentID 
     INNER JOIN questions on questions.question_id = StudentAnswers.question_id 
     INNER JOIN visualiztion_properties on visualiztion_properties.text_id = questions.text_id 
...
def get_answer_by_test_name_AVG(testName, visualization, set_num):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender, studentDivision, visualiztions.type, set_num,is_correct, AVG(time_to_answer)
     FROM StudentAnswers
     INNER JOIN StudentInfo on StudentAnswers.studentID = StudentInfo.studentID 
     INNER JOIN questions on questions.question_id = StudentAnswers.question_id 
     INNER JOIN visualiztion_properties on visualiztion_properties.text_id = questions.text_id 
...
def get_answer_by_test_name_reading_time(testName, visualization, set_num):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender, studentDivision, visualiztions.type, set_num, Summary, ReadingTime, SummaryTime
     FROM StudentInfo
...
def get_student_details(testName):
    return ("""SELECT StudentInfo.studentID, name, studentAge, studentGender, studentDivision
     FROM StudentAnswers
     INNER JOIN StudentInfo on StudentAnswers.studentID = StudentInfo.studentID
